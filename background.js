	...
	chrome.runtime.onMessage.addListener(
		function(request, sender, sendResponse) {
			...
			if (request.type === 'notify_fatigue') {
				...
				chrome.notification.create("Event countdown notification", {type: 'basic', title: 'Event countdown begun', message: 'An event is starting soon!', iconUrl: 'icon.png'});
				...
				chrome.notification.create("Event started notification", {type: 'basic', title: 'Event started', message: 'An event is currently underway!', iconUrl: 'icon.png'});
				...
				chrome.notification.create("Harvestron available", {type: 'basic', title: 'Harvestron available', message: 'Harvestron is now available!', iconUrl: 'icon.png'});
				...
				chrome.notification.create("Construction available", {type: 'basic', title: 'Construction available', message: 'Your workers are free!', iconUrl: 'icon.png'});
